...
{
  this->FlashlightSwitch = ExampleVTKReader->getFlashlightSwitch();
  this->FlashlightPosition = ExampleVTKReader->getFlashlightPosition();
  this->FlashlightDirection = ExampleVTKReader->getFlashlightDirection();
